...
Button(root,text="Add Route",font='Arial 12 bold',bg='green2',fg='black').grid(row=3,column=6,pady=20,padx=10)
Button(root,text="Delete Bus",font='Arial 12 bold',bg='green2',fg='black').grid(row=3,column=7,pady=20,padx=10)
home = PhotoImage(file='home.png')

Button(root,image=home).grid(row=4,column=7)
